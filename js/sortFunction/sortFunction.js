            ...
            categoryNodeList.forEach(category=>{
                if(category.id===categoryName) {
                    if(category.childNodes.length>1){
                        ...
                        document.querySelector('.sorting-select').style.backgroundColor="green"
                        setTimeout(()=>{
                            document.querySelector('.sorting-select').style.backgroundColor="black"
                        },2000)
                    }else{
                        document.querySelector('.sorting-select').style.backgroundColor="red"
                        setTimeout(()=>{
                            document.querySelector('.sorting-select').style.backgroundColor="black"
                        },2000)
                    }
